...
+ (NSMutableArray *)Syndromes
{
    ...
    [wallenberg setSyndromeDescription:@"AKA Lateral Medullary Syndrome. Occlusion of Vertabral a. or PICA  lateral medullary infaction."];
    ...
    [medialMedullary setSyndromeDescription:@"Occlusion of ASA or Basilar’s Paramedian branches  medial medullary infarction"];
    ...
    [jacksons setSyndromeDescription:@"Occlusion of Vertebral a. infarction of tegmental medulla"];
    ...
    [millardGubler setSyndromeDescription:@" AKA Ventral Pontine Syndrome. Occlusion of perforating branches of Basilar a.infarction of ventro-caudal pons"];
    ...
    [foville setSyndromeDescription:@"Occlusion of perforating branches of Basilar Artery  infarction of dorso-caudal pons."];
    ...
    [raymondCestan setSyndromeDescription:@"Occlusion of Circumferential Branches of Basilar Artery  Infarction of Dorso-rostral Pons:"];
    ...
    [webers setSyndromeDescription:@"AKA Medial Midbrain Syndrome.  Occlusion of Posterior Cerebral Artery (PCA) —> Infarction of ventral midbrain area."];
    ...
    [benedikts setSyndromeDescription:@" Occlusion of PCA or paramedian branches of Basilar a.  Infaction of Tegmental Midbrain and Cerebellum. AKA Paramedian Midbrain Syndrome.  "];
    ...
    [nothnagels setSyndromeDescription:@"Occlusion of Medial Posterior Choroidal Artery (branch of PCA)  infarction within Dorso-rostral Midbrain."];
    ...
    [claudes setSyndromeDescription:@"Occlusion of a branch of the PCA  infarction of ventral midbrain. Note: The cerebral peduncle is less involved in comparison to Weber’s."];
    ...
    [parinauds setSyndromeDescription:@"Usually due to compression of the Dorsal Midbrain area by a pineal mass. AKA Dorsal Midbrain Syndrome. "];
    ...
    [lockedIn setSyndromeDescription:@"Occlusion of Basilar a. (or major branches of) results in extensive damage in the pons"];
    ...
    [raymonds setSyndromeDescription :@"AKA Ventral Pontine Syndrome.  Occlusion of perforating branches of Basilar Artery causes deficits in ventro-caudal pons. (unlike Millard-Gubler's Syndrome, CN VII is not involved.)"];
